#! /bin/bash
## ROS noetic + Moveit! + Yolov8 + CUDA 11.7
...
CMD="export DEV_DIR=/home/user/shared_volume && \
    export CATKIN_WS=\$DEV_DIR/catkin_ws &&\
        source /home/user/.bashrc &&\
        if [ -f "/home/user/shared_volume/catkin_ws/devel/setup.bash" ]; then
            source /home/user/shared_volume/catkin_ws/devel/setup.bash
        fi &&\
         /bin/bash"
